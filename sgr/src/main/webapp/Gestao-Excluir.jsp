			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							Excluir Produto<small> - Excluir produto e suas informações	</small>
						</h1>
				...
				<form>
					<div class="form-group">
						<div class="col-xs-6">
							<div class="form-group">
								<label for="sel2">Selecione um item da lista para exclusão:</label> <select
					...
					<div class="col-xs-12">
						...
						<a href="Gestao.jsp" class="btn btn-danger">Excluir</a>
					</div>
				</form>
			</div>
			<!-- /.container-fluid -->
